...
(function (SafetyLevel) {
    SafetyLevel[SafetyLevel["SAFE_LEVEL_1"] = 1] = "SAFE_LEVEL_1";
    SafetyLevel[SafetyLevel["SAFE_LEVEL_2"] = 2] = "SAFE_LEVEL_2";
    SafetyLevel[SafetyLevel["SAFE_LEVEL_3"] = 3] = "SAFE_LEVEL_3";
    SafetyLevel[SafetyLevel["SAFE_LEVEL_4"] = 4] = "SAFE_LEVEL_4";
...
export class Phase16FixStrategyGeneration {
     ...
     */
    async analyzeFileDependencies(sourceFiles) {
     ...
     */
    generateFixStrategies(fileDependencies) {
        const strategies = [];
...
//# sourceMappingURL=phase-16-fix-strategy-generation.js.map