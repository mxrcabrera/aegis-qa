...
export class Phase18PostFixValidation {
     ...
     */
    async performGlobalIntegrityCheck(preFixBaseline) {
     ...
     */
    detectNewErrors(preFixErrors, postFixErrors) {
        // Create a Set of pre-fix error signatures for O(1) lookup
        const preFixErrorSignatures = new Set();
     ...
     */
    extractFindingsFromPhaseData(phaseData) {
     ...
     */
    isRegression(preFixFinding, postFixError) {
     ...
     */
    async performStrictRegressionCheck() {
     ...
     */
    getModifiedFiles(phase17Data) {
        const modifiedFiles = [];
        const data = phase17Data;
     ...
     */
    async performFinalSanitization() {
     ...
     */
    findZombieBackupFolders() {
        const zombieFolders = [];
        const findFoldersRecursive = (dir) => {
...
//# sourceMappingURL=phase-18-post-fix-validation.js.map