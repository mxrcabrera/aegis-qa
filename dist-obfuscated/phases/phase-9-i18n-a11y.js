...
export class Phase9I18nA11y {
    ...
    async execute() {
        ...
        try {
            ...
            for (const file of files) {
                ...
                const timeoutResult = await runWithFileTimeout(() => this.analyzeFile(file, criticalModules, isFintech), file, { timeoutMs: 60000 });
     ...
     */
    async analyzeFile(filePath, criticalModules, isFintech) {
        const findings = [];
        try {
     ...
     */
    analyzeI18n(filePath, content, fileHash, isFintech) {
        const findings = [];
     ...
     */
    analyzeA11y(filePath, content, fileHash, isCriticalModule, _isFintech) {
        const findings = [];
...
//# sourceMappingURL=phase-9-i18n-a11y.js.map