...
export class Phase8Performance {
     ...
     */
    async analyzeFile(filePath, databaseFindings, criticalModules, complexityScores, isFintech) {
        const findings = [];
        try {
     ...
     */
    analyzeResourceLeaks(filePath, content, fileHash, criticalModules, isFintech) {
        const findings = [];
     ...
     */
    analyzeComputationalWaste(filePath, content, fileHash, criticalModules, complexityScores) {
        const findings = [];
        const isCriticalModule = criticalModules.includes(filePath);
     ...
     */
    analyzeScalabilityPatterns(filePath, content, fileHash, databaseFindings, criticalModules, isFintech) {
        const findings = [];
        const isCriticalModule = criticalModules.includes(filePath);
...
//# sourceMappingURL=phase-8-performance.js.map