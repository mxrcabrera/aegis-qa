...
export class Phase3Security {
     ...
     */
    async analyzeFile(filePath, criticalModules, domain) {
        const findings = [];
        try {
     ...
     */
    detectSecrets(filePath, content, fileHash, inCriticalModule) {
        const findings = [];
     ...
     */
    detectInjections(filePath, content, fileHash, inCriticalModule) {
        const findings = [];
        // eval() usage
     ...
     */
    detectSensitiveDataLeaks(filePath, content, fileHash, inCriticalModule, domain) {
        const findings = [];
     ...
     */
    applySecurityMultiplier(findings, domain) {
     ...
     * @private
     */
    async runSubPhase3B_AI_API_Security() {
     ...
     * @private
     */
    async runSubPhase3C_SecureDevMethodology() {
     ...
     * @private
     */
    async runSubPhase3E_BaaSPlatformSecurity() {
     ...
     * @private
     */
    async runSubPhase3F_WebhookSecurity() {
     ...
     * @private
     */
    async runSubPhase3G_DataPrivacyPII() {
     ...
     */
    async writePartialReport(result, domain, criticalModulesCount) {
        try {
...
//# sourceMappingURL=phase-3-security.js.map