...
export class Phase5CleanCode {
     ...
     */
    async analyzeFile(filePath, criticalModules, qualityScores, liteScanMode) {
        const findings = [];
        try {
     ...
     */
    analyzeSOLID(filePath, content, fileHash, isCriticalModule) {
        const findings = [];
     ...
     */
    analyzeCodeSmells(filePath, content, fileHash, _isCriticalModule, complexity) {
        const findings = [];
        const lines = content.split('\n');
...
//# sourceMappingURL=phase-5-clean-code.js.map