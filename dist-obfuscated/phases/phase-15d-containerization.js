...
export class Phase15CContainerization {
    ...
    async execute() {
        ...
        try {
            ...
            const allFindings = this.generateFindingsFromAudit(containerizationAudit);
     ...
     */
    async performContainerizationAudit() {
        const result = {
            dockerfileFiles: [],
            securityIssues: [],
            costInefficiencies: [],
    ...
    isProductionEnvironment() {
        ...
        try {
            ...
            const hasProductionScripts = scripts['start:prod'] ||
                scripts['build:prod'] ||
                scripts['deploy'] ||
                scripts['production'];
            // Check for production-related dependencies
            const dependencies = { ...packageJson.dependencies, ...packageJson.devDependencies };
            const hasProductionDeps = dependencies['pm2'] ||
                dependencies['nginx'] ||
     ...
     */
    analyzeDockerfile(filePath, result) {
        try {
...
//# sourceMappingURL=phase-15d-containerization.js.map