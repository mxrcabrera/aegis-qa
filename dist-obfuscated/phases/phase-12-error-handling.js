...
export class Phase12ErrorHandling {
    ...
    async execute() {
        ...
        try {
            ...
            await batchProcessor.processFiles(files, async (filePath) => {
                ...
                const fileTimeout = new Promise((resolve) => {
                    setTimeout(() => resolve([{
     ...
     */
    async analyzeFile(filePath, corePathFiles) {
        const findings = [];
     ...
     */
    async writePartialReport(findings, observabilityAudit, criticalFindings, highSeverityFindings) {
        try {
...
`;
     ...
     */
    maskSensitiveData(logStatement) {
...
//# sourceMappingURL=phase-12-error-handling.js.map