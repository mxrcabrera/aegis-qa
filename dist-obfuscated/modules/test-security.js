 ...
 */
async function createTestProject(testName) {
 ...
 */
function createClientLeakFile(testDir) {
 ...
 */
function createServerActionFile(testDir) {
 ...
 */
function createSqlWithoutRLS(testDir) {
 ...
 */
function createSqlWithRLS(testDir) {
 ...
 */
function createInsecureConfig(testDir) {
 ...
 */
async function runSecurityScannerTests() {
